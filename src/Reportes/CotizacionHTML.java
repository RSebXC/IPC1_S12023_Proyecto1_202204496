...
public class CotizacionHTML {
  ...
  public boolean CrearDoc(String nombre,String codigo,  String user, String cantidad, String Tamaño, String Dorigen, String MunO,String nit, String Tpago){
        this.nombre = nombre;
        try {
            ...
            crearReporte(nombre,codigo, user, cantidad,Tamaño,Dorigen,MunO,nit,Tpago);
    ...
    public void crearReporte(String titulo,String codigo,String nombre,  String cantidad, String Tamaño, String Dorigen, String MunO,String nit, String Tpago){
        ...
        nextLine();
        /* Datos del usuario */
        datosUsuario(codigo,nombre,Dorigen,MunO,nit);
        /* Salto de linea */
        nextLine();
        /* Creacion de la tabla de productos*/
        nuevaTabla(cantidad,Tamaño,Tpago);
    ...
    private void datosUsuario(String codigo,String nombre, String Dorigen, String MunO, String nit){
        ...
        nextData("Nit del cliente: " + nit);
        nextData("Direccion" + MunO + ", " + Dorigen);
